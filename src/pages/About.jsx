        ...
        <section id="about" className="bg-bg px-20 py-16">
            ...
            <div className="flex gap-8 mb-10">
                ...
                <div className="max-w-200">
                    ...
                    <p className="font-display italic text-[clamp(14px,1.2vw,16px)] text-muted leading-[1.85] mb-1 tracking-wide">
            ...
            <div className="border-t border-neon/12 pt-5">
                <p className="font-mono text-xs text-neon/70 tracking-[0.4em] mb-5">
                    — education
                </p>
                ...
                <div className="flex flex-col">
                    {education.map(({ period, title, detail }, i) => (
                        ...
                        >
                            ...
                            <div>
                                <p className="font-display text-lg text-cream leading-tight mb-1">
                                    {title}
                                </p>
